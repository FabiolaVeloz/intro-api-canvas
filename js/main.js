...
function drawRectangulo() {
  ...
  if (canvas1.getContext) {
    ctx1.fillStyle='#082050';
    ctx1.strokeStyle='#098DBF';
    ctx1.fillRect(25, 25, 100, 100); // Crea el recuadro relleno
    ctx1.clearRect(45, 45, 60, 60); // Limpia el área
    ctx1.strokeRect(50, 50, 50, 50); // Crea otro recuadro
  }
}
...
function drawCarita() {
  ...
  function drawFlechas() {
    if (canvas4.getContext) {
      ...
      ctx.fillStyle='#3B0593';
      ctx.strokeStyle='#60DFB7';
      // Triángulo relleno
      ctx.beginPath();
      ctx.moveTo(25, 25);
      ctx.lineTo(105, 25);
  ...
  function drawArco() {
    if (canvas5.getContext) {
      ...
      for (let i = 0; i < 4; i++) {
        for (let j = 0; j < 3; j++) {
          ctx.beginPath();
          ctx.fillStyle='#2A1981';
          ctx.strokeStyle='#6553C0';
  ...
  function drawCombined() {
    if (canvas8.getContext) {
      ...
      ctx.beginPath();
      ctx.fillStyle='#2CABF9';
      ctx.strokeStyle='#6FBCEB';    
  ...
  function drawPath() {
    ...
    if (canvas9.getContext) {
      ...
      ctx.fillStyle='#082050';
      ctx.strokeStyle='#098DBF';
